...
if RUNNING_ON_SERVER:
    ...
    POSE_OUTPUT_PATH = "/workspace/data/ro-state-files/radar_oxford_10k/2019-01-10-11-46-21/"
...
RADAR_DATASET_PATH = "/workspace/data/ro-state-files/radar_oxford_10k/2019-01-10-11-46-21/ro_state.monolithic"
