...
# TODO -> visualise deltas between matched landmarks

def find_landmark_deltas(params):
    landmarks_path = params.landmarks_path
    figure_path = landmarks_path + "figs_delta_landmarks/"
