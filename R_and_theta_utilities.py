...
def make_plot(landmarks, start_position, end_position, radius, landmark_ranges, estimated_radius=None):
...
def multiple_landmarks_test():
    ...
    make_plot(landmarks, start_position, end_position, k_radius, landmark_ranges)
...
def single_landmark_test():
    ...
    make_plot(landmark_1, start_position, end_position, k_radius, landmark_ranges, estimated_radius=radius)
