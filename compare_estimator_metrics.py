...
def get_metrics(params):
    ...
    # Aux 0 - using the ransac inliers only in the SVD estimate - cropping from 6900 to just the first 2000 frames
    aux0_timestamps, aux0_x_y_th = get_timestamps_and_x_y_th_from_csv(params.path + "6900_ransac_inliers_svd_poses.csv")

    # Aux 1
    aux1_timestamps, aux1_x_y_th = get_timestamps_and_x_y_th_from_csv(
        params.path + "6900_means_iqr_poses_theta_25_75.csv")

    # Aux 2
    aux2_timestamps, aux2_x_y_th = get_timestamps_and_x_y_th_from_csv(
        params.path + "6900_means_iqr_poses_curvature_25_75.csv")

    # Aux 3
    aux3_timestamps, aux3_x_y_th = get_timestamps_and_x_y_th_from_csv(params.path + "6900_double_iqr_poses_25_75.csv")

    # Aux 4
    aux4_timestamps, aux4_x_y_th = get_timestamps_and_x_y_th_from_csv(params.path + "2000_KDE.csv")

    # # Aux 5
    # aux5_timestamps, aux5_x_y_th = get_timestamps_and_x_y_th_from_csv(params.path + "2000_means_sd_poses.csv")
    ...
    aux1_timestamps, aux1_x_y_th = aux1_timestamps[:2000], aux1_x_y_th[:2000]
    aux2_timestamps, aux2_x_y_th = aux2_timestamps[:2000], aux2_x_y_th[:2000]
    aux3_timestamps, aux3_x_y_th = aux3_timestamps[:2000], aux3_x_y_th[:2000]
